...
bucket.download_file("train/train_metadata.csv", "train_data/train_metadata.csv")
metadata_file = open("train_data/train_metadata.csv")
...
def load_data(num_threads, thread_num, test_data=True, reader=reader):
    ...
    for line in tqdm(reader):
        ...
        bucket.download_file(f"train/iqdata/{data_file_name}", f"train_data/iqdata/{data_file_name}")
        iq_data = np.fromfile(f"train_data/iqdata/{data_file_name}")
        # stack array
